...
Ainsi en utilisant cette fonction, nous avons défini un potentiel à deux dimensions qui a l'allure suivante 
...
\end{subfigure}
\caption{Potentiel global utilisé ainsi que les équipotentielles.}
\end{figure}
